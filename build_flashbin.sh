...
cp -v ../trusted-firmware-a/build/imx8mp/release/bl31.bin iMX8M/bl31.bin
cp -f /tmp/uboot-imx8mp/spl/u-boot-spl.bin iMX8M/
cp -f /tmp/uboot-imx8mp/u-boot-nodtb.bin iMX8M/
cp -f /tmp/uboot-imx8mp/u-boot.dtb iMX8M/imx8mp-evk.dtb
cp -f ../imx-optee-os/build.mx8mpevk/tee.bin iMX8M/tee.bin
